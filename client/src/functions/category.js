...
export const createCategory = async (token, name) => {
    return await axios.post(`${process.env.REACT_APP_API}/${CREATE}`, { name }, {
        headers: {
            token
        }
    });
...
export const updateCategory = async (token, name, slug) => {
    return await axios.put(`${process.env.REACT_APP_API}/${UPDATE}/${slug}`, { name }, {
        headers: {
            token
        }
    });
...
export const removeCategory = async (token, slug) => {
    return await axios.delete(`${process.env.REACT_APP_API}/${REMOVE}/${slug}`, {
        headers: {
            token
        }
    });
